...
{
  return htmlentities($str, $flags, CKaisan::Instance()->config['character_encoding']);
}
...
{
  echo "Kaisan: Uncaught exception: <p>" . $exception->getMessage() . "</p><pre>" . $exception->getTraceAsString(), "</pre>";
}
